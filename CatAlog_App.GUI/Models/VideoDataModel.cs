...
namespace CatAlog_App.GUI.Models
{
    ...
    {
        internal DtoVideoDataModel _videoModel;

        private int _number;

        public VideoDataModel(DtoVideoDataModel videoModel)
        {
        ...
        {
            _videoModel = new DtoVideoDataModel();
        }
        ...
        internal DtoVideoDataModel GetModel() => _videoModel;
    }
}
