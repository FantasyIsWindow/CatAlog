...
namespace CatAlog_App.GUI.Models
{
    ...
    {
        private DtoAudioDataModel _audioModel;

        private int _number;

        public AudioDataModel(DtoAudioDataModel audioModel)
        {
        ...
        {
            _audioModel = new DtoAudioDataModel();
        }
        ...
        internal DtoAudioDataModel GetModel() => _audioModel;
    }
}
